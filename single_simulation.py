...
def run():
    ...
    # Fixed parameters
    R_bar = st.sidebar.number_input('R_bar', min_value=0.0, max_value=1000.0, value=1.0, step=0.1)
    C_0 = st.sidebar.number_input('C_0', min_value=0.0, max_value=1000.0, value=1.0, step=0.1)
